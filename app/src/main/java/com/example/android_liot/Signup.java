    ...
    public void action(){
        signup_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(signup_confirm_pass.getText().toString()!=" " && signup_pass.getText().toString().equals(signup_confirm_pass.getText().toString())){
                    Intent intent = new Intent(Signup.this, Login.class);
                    startActivity(intent);
                }
                else{
                    System.out.println(signup_pass.getText());
                    System.out.println(signup_confirm_pass.getText());
